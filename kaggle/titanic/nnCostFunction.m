...
Theta3_grad = (Theta3_grad + lambda * [zeros(size(Theta3, 1), 1) Theta3(:, 2:end)]) ./ m;

J += lambda * (sum(sum(Theta1(:,2:end) .* Theta1(:,2:end))) + ...
